...
# Button Labels
L_TRIGGER_LABEL = "L2/LT"
R_TRIGGER_LABEL = "R2/RT"
BTN_A_LABEL = "X/A"
BTN_B_LABEL = "O/B"
BTN_X_LABEL = "Sqaure/X"
BTN_Y_LABEL = "Triangle/Y"
...
def update_button_labels(name):
    ...
    if "xbox" in name_lower or "xinput" in name_lower or "microsoft" in name_lower:
        ...
        BTN_A_LABEL = "X"; BTN_B_LABEL = "O"; BTN_X_LABEL = "Sqaure"; BTN_Y_LABEL = "Triangle"
...
dpg.create_viewport(title="JamPad Classic", width=420, height=550, small_icon=icon_path, large_icon=icon_path)
dpg.setup_dearpygui()

with dpg.window(tag="main_window", width=420, height=550):
    with dpg.tab_bar():
        # ─── MAIN TAB ───
        ...
        with dpg.tab(label="Settings"):
            ...
            dpg.add_slider_float(label="Move Threshold", default_value=MOVEMENT_THRESHOLD, max_value=1.0, callback=update_param, user_data="move", tag="mv_slider", height=26)
        ...
        with dpg.tab(label="Profiles"):
            ...
            dpg.add_input_text(label="Name Config", tag="profile_name", height=30)
